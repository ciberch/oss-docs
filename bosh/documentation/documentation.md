...
If you type bosh you will see the list of available commands:
...
Job management
  ...
  rename <old_job_name> <new_job_name>
                            renames a job. NOTE, your deployment manifest
                            must also be updated to reflect the new job name.
...
Download the [BOSH Command Line Interface](http://rubygems.org/gems/bosh_cli) gem to use the bosh command.
